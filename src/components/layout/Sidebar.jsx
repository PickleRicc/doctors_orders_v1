...
function Sidebar({ collapsed = false, onToggleCollapse }) {
  ...
  // Sidebar classes based on collapsed state - Floating Glass Style
  const sidebarClasses = collapsed
    ? 'h-[calc(100vh-2rem)] w-[72px] bg-white/70 dark:bg-[#1a1a1a]/70 backdrop-blur-xl border border-white/20 dark:border-white/10 rounded-2xl shadow-xl transition-all duration-300 ease-in-out z-20 overflow-hidden'
    : 'h-[calc(100vh-2rem)] w-[260px] bg-white/70 dark:bg-[#1a1a1a]/70 backdrop-blur-xl border border-white/20 dark:border-white/10 rounded-2xl shadow-xl transition-all duration-300 ease-in-out z-20 overflow-y-auto';
