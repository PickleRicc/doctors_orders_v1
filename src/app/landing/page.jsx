...
export default function LandingPage() {
  ...
  return (
    <div className="min-h-screen bg-black text-white relative overflow-x-hidden selection:bg-blue-primary/30">
      <HeroBackground />
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center h-20">
            <div className="flex items-center gap-3 cursor-pointer" onClick={() => router.push('/')}>
              <div className="w-10 h-10 rounded-xl overflow-hidden flex-shrink-0 bg-gradient-to-br from-blue-primary to-blue-dark p-[1px]">
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            >
              <motion.div
                ...
                className="inline-flex items-center gap-2 px-4 py-2 bg-white/5 border border-white/10 rounded-full text-sm font-medium text-blue-primary backdrop-blur-sm"
              >
              ...
              <h1 className="text-6xl md:text-7xl lg:text-8xl font-bold leading-tight tracking-tight">
                Focus on <br />
                <span className="text-transparent bg-clip-text bg-gradient-to-r from-blue-primary via-blue-light to-blue-dark animate-gradient-x">
                  Patients
                </span>
                <br />
                Not Paperwork.
              ...
              <div className="flex flex-wrap gap-4 pt-4">
                <MagneticButton
                  onClick={() => router.push('/auth')}
                  className="px-8 py-4 bg-blue-primary text-white rounded-full hover:bg-blue-dark transition-all font-semibold text-lg flex items-center gap-2 shadow-lg shadow-blue-primary/25"
                >
                  Get Started Free
              ...
              <div className="flex items-center gap-4 text-sm text-gray-500 pt-4 pb-12">
            ...
            >
              <TiltContainer>
                <div className="relative w-full aspect-[4/3] max-w-lg mx-auto">
                  {/* Background Glow */}
                  <div className="absolute inset-0 bg-gradient-to-tr from-blue-primary/20 to-blue-dark/20 rounded-3xl blur-3xl transform scale-110" />
                    ...
                    <div className="flex-1 p-6 space-y-6">
                      <div className="flex gap-4">
                        ...
                        <div className="w-2/3 space-y-4">
                          <div className="h-8 w-3/4 bg-blue-primary/20 rounded-lg" />
                          ...
                          <div className="h-32 bg-white/5 rounded-xl border border-white/5 p-4">
                            <div className="flex items-center gap-2 mb-3">
                              ...
                              <div className="text-xs text-blue-primary font-medium">AI Analysis</div>
                            </div>
                            <div className="space-y-2">
                              <div className="h-2 w-full bg-blue-primary/10 rounded-full" />
                              <div className="h-2 w-full bg-blue-primary/10 rounded-full" />
                              <div className="h-2 w-3/4 bg-blue-primary/10 rounded-full" />
                            </div>
                          </div>
                        </div>
                      </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-20">
            <h2 className="text-4xl md:text-5xl font-bold mb-6">
              ...
              <span className="text-blue-primary">streamline documentation</span>
            </h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            ...
            <div className="md:col-span-2">
              <SpotlightCard className="h-full p-8 group">
                ...
                <div className="relative z-10">
                  <div className="w-12 h-12 bg-blue-primary/20 rounded-xl flex items-center justify-center mb-6">
                    <Clock className="w-6 h-6 text-blue-primary" />
                  </div>
                  ...
                  <div className="grid grid-cols-2 gap-4 max-w-sm">
                    <div className="bg-black/20 rounded-xl p-4 border border-white/5">
                      <div className="text-3xl font-bold text-blue-primary mb-1">75%</div>
                      <div className="text-sm text-gray-500">Time Saved</div>
                    </div>
                    <div className="bg-black/20 rounded-xl p-4 border border-white/5">
                      <div className="text-3xl font-bold text-blue-primary mb-1">&lt;60s</div>
            ...
            <div className="h-full">
              <SpotlightCard className="h-full p-8" spotlightColor="rgba(var(--blue-primary-rgb), 0.25)">
                <div className="w-12 h-12 bg-blue-dark/20 rounded-xl flex items-center justify-center mb-6">
            ...
            {features.map((feature, index) => (
              <SpotlightCard key={feature.title} className="p-8" spotlightColor="rgba(var(--blue-primary-rgb), 0.15)">
      ...
      <section className="py-32 relative">
        <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            <div className="absolute inset-0 bg-gradient-to-br from-blue-primary to-blue-dark" />
            ...
            <div className="relative z-10 px-8 py-20 md:p-20 text-center">
              ...
              <MagneticButton
                onClick={() => router.push('/auth')}
                className="px-10 py-5 bg-white text-blue-primary rounded-full hover:bg-blue-50 transition-all font-bold text-lg shadow-xl shadow-black/20"
              >
                Start Free Trial
              </MagneticButton>
            </div>
